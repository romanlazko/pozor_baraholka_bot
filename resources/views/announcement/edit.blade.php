<x-telegram::layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex-col">
                <x-telegram::a-buttons.secondary href="{{ route('pozor_baraholka_bot.announcement.index') }}" class="float-right">
                    {{ __("←Back") }}
            ...
            <div class="flex-col max-w-xl w-full sm:w-1/2 ">
                <x-telegram::white-block>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Use this form to create announcement.') }}
                    </p>
                    <form method="post" action="{{ route('pozor_baraholka_bot.announcement.store') }}" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div>
